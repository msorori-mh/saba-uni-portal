...
-- private file metadata, discussion scheduling/panels/outcomes, evaluation entry,
-- result conclusion, corrections, plus assignment-scoped read/report RPCs.
-- No production migration, bucket, policy, workflow, or feature activation is authorized.
-- Project/coordinator bootstrap identities remain a separate privileged gate (G4).
