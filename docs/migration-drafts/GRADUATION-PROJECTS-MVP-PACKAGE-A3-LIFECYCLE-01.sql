-- DRAFT ONLY — DO NOT APPLY. GRADUATION-PROJECTS-MVP-PACKAGE-A3-LIFECYCLE-01
-- Contract: docs/PORTAL-GRADUATION-PROJECTS-MVP-SCOPE-AND-CONTRACT-FREEZE-01.md @ 7b67539a
-- Package A / A3: lifecycle write/read RPCs. Coordinator-only ops; no title bypass.
-- final_decision separate from lifecycle_state. discussion* names retained for defense compatibility.
