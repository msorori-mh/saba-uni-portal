-- PORTAL_B1_PAYMENT_E2E_GATE_MIGRATION_AND_TRANSFER_RESUME_149
-- Single forward change: add the Migration-88 request-scoped E2E OR branch to the
-- exact-processing-binding gate inside
-- public.record_external_university_payment_confirmation(uuid,text).
-- Everything else in the function body is byte-preserved from the current production
-- definition (pre-SHA md5 3fa571291e4ed6f3439e2b3d2d1fe232).
-- No other function/table/policy/grant/RLS/RPA/data change.
