-- DRAFT ONLY -- DO NOT APPLY. GRADUATION-PROJECTS-MVP-PACKAGE-A2-STORAGE-01
-- Contract: docs/PORTAL-GRADUATION-PROJECTS-MVP-SCOPE-AND-CONTRACT-FREEZE-01.md @ 7b67539a
-- Package A / A2 private storage: bucket contract, INSERT policy, upload/finalize/download RPCs.
-- Bucket id/name: graduation-projects (private, PDF only). Production bucket apply is separately authorized.
...
begin
  ...
  -- TEST seam: set gp.verify.skip_storage_object_check=on or omit storage.objects in disposable PG17 stubs.
...
-- Contract-only orphan inventory. Never deletes storage.objects in MVP source; Package D may execute deletes in safe env.
