...
|---|---|---|---|---|
| #181 | docs: portal swarm coordination program 01 | تنسيق docs-only (هذا البرنامج) | مراجعة مستقلة: REVISE→تصحيحات مطبقة | قيد المراجعة النهائية |
| #155 | feat: current-term course read contract (draft) | مصدر | build محلي HOLD؛ CI هو الحكم | إبقاء — D-20 |
| #149 | docs: cohort/delivery-group integration audit (draft) | توثيق معماري — مسودة غير مدموجة | مراجعة 0/0/0/0 | إبقاء — D-20 |
...
## PRs محسومة هذه الدورة (2026-07-21)

| PR | العنوان | القرار | السند |
|---|---|---|---|
| #177 | independent review of B1 activation preflight 02 | ✅ مغلق — SUPERSEDED_BY_RECONCILIATION | تحقق مستقل: 18/18 MATCH (اسم+SHA) مع runbook-07 على main@ff570f3b؛ المواضع 1/4/5 مطابقة؛ عبارة LOW محذوفة |
| #178 | review: graduation projects MVP foundation 01 | ✅ مغلق — SUPERSEDED_BY_MERGED_REMEDIATION | تحقق مستقل: commits 4559fdd→fff3e73 داخل #174 عالجت HIGH-01+MEDIUM-01..04+LOW-01 قبل الدمج f970b9c؛ لا commit لاحق على main يمس الملفات |

## PRs مدموجة — دورة التوازي الأخيرة (18–21 يوليو)

| PR | العنوان | الدمج | القرار |
|---|---|---|---|
| #180 | reconcile portal parallel activation and expansion cycle | `ff570f3` | سجل الحقيقة المرحلي الحاكم |
| #179 | graduates affairs MVP foundation 01 | `53c4014` | PASS_SOURCE_READY (0/0/0) |
| #176 | B1 production activation command cycle 01 | `367d899` | FIRST_MIGRATION_READY = NONE |
...
| #172 | accept legal Lovable generated Register footer | `427b7eb` | validator fail-closed |
| #171 | stabilize TanStack Start Register augmentation | `a7d73d4` | مرتبط ببوابة B-4 |
| #170 | make B1 release build reproducible | `7431601` | — |
| #169 | B1 runtime predecessor guard | `7501156` | 285/285 PG17 |
| #167 | B1 preflight blockers remediation (log_audit) | head `f3ab024` (مدموج 2026-07-18) | SOURCE REMEDIATED |
