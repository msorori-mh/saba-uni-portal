...
**تحديث (PDF-STORAGE-GENERATOR-01):** كان `HOLD_APPROVED_ARABIC_FONT_ASSET_REQUIRED` (+ Runtime).

**تحديث (ARABIC-PDF-WORKER-SPIKE-01):**

- `PASS_ARABIC_PDF_WORKER_SPIKE_READY_FOR_STORAGE_SAGA_IMPLEMENTATION`
- بوابة الإنتاج المتبقية: `HOLD_PDF_STORAGE_SAGA_NOT_IMPLEMENTED`

انظر: `docs/ENROLLMENT-CERTIFICATE-ARABIC-PDF-WORKER-SPIKE-01-REPORT.md` و`docs/ENROLLMENT-CERTIFICATE-PDF-STORAGE-GENERATOR-01-REPORT.md`
