...
| 6 | `EXTERNAL-UNIVERSITY-PAYMENT-CONFIRMATION-01.sql` | `41ab67a1208f926400799d2c6870dd44015e59fbbb9a7d6adaba4faf9d3b7f84` | External university confirmation; no `fee_type.code`, amount, currency, invoice, gateway transaction, or internal balance; replacement action_type constraint is a superset of the applied one (`assess_fee` retained for the live `enrollment_certificate` fee machinery) |
...
| 13 | `FINAL-CHANCE-CANONICAL-WRITE-03.sql` | `1378250a44374a782b612198262ca9c3a4afb9e87afe449179f5de28b2a2535a` | Final exam chance only; new writes use `final_chance`; no scan or backfill |
