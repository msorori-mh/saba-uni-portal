...
| 6 | `EXTERNAL-UNIVERSITY-PAYMENT-CONFIRMATION-01.sql` | `aae12fefe62eebeed98d808aa1f3fa91eedcd94fb18f74e47bd063a0174f8993` | External university confirmation; no `fee_type.code`, amount, currency, invoice, gateway transaction, or internal balance; replacement action_type constraint is a superset of the applied one (`assess_fee` retained for the live `enrollment_certificate` fee machinery) |
