...
Mission: `PORTAL-FINAL-RC313-REPORTS320-INTEGRATION-AND-FINAL-RC-CLOSURE-LONGRUN-07`
(prior: `PORTAL-FINAL-RC313-REPORTS318-SEMANTIC-INTEGRATION-AND-FINAL-SOURCE-CLOSURE-LONGRUN-06`
...
This tip is the FINAL SOURCE RC composition including Reports #318 + three-level
UX #320. B1 (#310) remains integrated.
...
FINAL_RC_HEAD_SHA=b5054b4db90a77c3573932ecbecb66a07bfd99f6
...
## LONGRUN-05 CI closure

```
WEB_CI=PASS
MIGRATION_REVIEW=PASS
B1_DEFINITIVE_OPERATOR_JOB=PASS
FINAL_RC_CI_GREEN_TIP_SHA=fce000cb7a3823d96c7bcefbbad80ea3331a1f79
```

## LONGRUN-07 — Reports #320 three-level UX integration

```
PRE_REPORTS320_RC_HEAD_SHA=afe5f55b545aceb9f761ee8a508818c19068db07
REPORTS320_HEAD_SHA=57010a34ee06863ac23558c3b71c79ef3743a9dd
...
- `#320` is UX-only (Attention → KPIs → Catalog) on existing beneficiary hubs.
- Catalog counts unchanged vs LONGRUN-06 (CODE IS TRUTH).
- `FINAL_RC_HEAD_SHA` is the Draft tip after LONGRUN-07 docs pin (+ optional CI-align pin).
