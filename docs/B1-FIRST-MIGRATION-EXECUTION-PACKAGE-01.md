...
5. **حالة PR #202 (أمانة):** مفتوح، محتواه اجتاز المراجعة (content-PASS)، لكنه محجوز بعطلة GitHub Actions (`mergeable_state = unstable`)؛ لم يُدمج. الحظر يُرفع فقط عند وصول التقرير إلى main مع CI أخضر.
