# SEQ12 — Lovable Production Prompt (DOCUMENTATION ONLY — DO NOT RUN FROM THIS TRACK)
...
| LF SHA-256 | `224186f4b9b06b9b57e9460492e7bc74383e8bd18a949bf66b4946aff9d84cd9` |
| Preflight | `docs/migration-drafts/b1-backend-verifiers/12-B1_12_TRANSFER_SECURE_ATTACHMENT_05A-PREFLIGHT.sql` |
| Post-verifier | `docs/migration-drafts/b1-backend-verifiers/12-B1_12_TRANSFER_SECURE_ATTACHMENT_05A-POST-VERIFIER.sql` |
...
1. Apply **exactly one** file: `20260725110500_b1_12_transfer_secure_attachment_05a.sql`
