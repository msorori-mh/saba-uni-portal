# SEQ21 — Lovable Production Prompt (DOCUMENTATION ONLY — DO NOT RUN FROM THIS TRACK)
...
| LF SHA-256 | `cd71670022c534d15639c530acd4135b72a15cb053debf554d90c6e2405385ca` |
| Preflight | `docs/migration-drafts/b1-backend-verifiers/21-B1_21_SECURE_READ_CONTRACTS_01-PREFLIGHT.sql` |
| Post-verifier | `docs/migration-drafts/b1-backend-verifiers/21-B1_21_SECURE_READ_CONTRACTS_01-POST-VERIFIER.sql` |
...
1. Apply **exactly one** file: `20260725130000_b1_21_secure_read_contracts_01.sql`
...
Read-contract track at promotion-map/sequence 21. Does not open create/save draft writes. Activation gate is 25.
