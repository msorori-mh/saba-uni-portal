# SEQ09 — Lovable Production Prompt (DOCUMENTATION ONLY — DO NOT RUN FROM THIS TRACK)
...
| LF SHA-256 | `9ecf6c57167a748399edd0798e9b100e3a6ec9bbad4d09975df448f73fa41ae0` |
| Preflight | `docs/migration-drafts/b1-backend-verifiers/09-B1_09_EXCUSED_ABSENCE_VOCABULARY_05A-PREFLIGHT.sql` |
| Post-verifier | `docs/migration-drafts/b1-backend-verifiers/09-B1_09_EXCUSED_ABSENCE_VOCABULARY_05A-POST-VERIFIER.sql` |
...
1. Apply **exactly one** file: `20260725110200_b1_09_excused_absence_vocabulary_05a.sql`
