...
`FILES_MODIFIED=` only this review report in the current worktree. The temporary full-chain test harness/worktree was disposable and removed after execution.  
