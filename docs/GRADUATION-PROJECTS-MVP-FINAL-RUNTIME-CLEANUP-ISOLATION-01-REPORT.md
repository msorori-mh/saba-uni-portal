...
- any `PACKAGE_D_TEST_ONLY_HELPERS` export (no TEST_ONLY names remain under `src/`)
...
| Final reconciliation | `5ab35eead83659d741481c79c37df05f54047bc6` |
| Final integration HEAD | tip of `origin/integration/gp-mvp-01` (includes this report pin) |
