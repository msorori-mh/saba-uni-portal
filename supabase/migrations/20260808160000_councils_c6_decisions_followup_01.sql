-- =====================================================================
-- ACADEMIC-COUNCILS-C6-DECISIONS-AND-FOLLOWUP-01
-- PROMOTED MIGRATION - NOT APPLIED TO PRODUCTION
-- REQUIRES EXPLICIT SINGLE-MIGRATION APPROVAL
--
-- Scope:
--   Decision linkage to meeting, agenda item, and minutes evidence
--   Canonical decision number generation
--   Responsible actor execution & progress evidence updates
--   Immutability of decision text & linkage after minutes lock
--   Controlled status transitions (issued -> in_progress -> completed / blocked)
--   Chair oversight and Secretary recording rules
--   No automatic academic decision authority for system admins/deans
-- =====================================================================
