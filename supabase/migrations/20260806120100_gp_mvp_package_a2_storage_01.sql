...
-- Package: GRADUATION-PROJECTS-MVP-PACKAGE-A / A2 private storage
-- Source draft: docs/migration-drafts/GRADUATION-PROJECTS-MVP-PACKAGE-A2-STORAGE-01.sql
-- Contract: docs/PORTAL-GRADUATION-PROJECTS-MVP-SCOPE-AND-CONTRACT-FREEZE-01.md @ 7b67539a
-- Bucket contract: graduation-projects (private, PDF only, no public URL)
