-- =====================================================================
-- ACADEMIC-COUNCILS-C0-C8-FINAL-SECURITY-CLOSURE-01
-- PROMOTED MIGRATION - NOT APPLIED TO PRODUCTION
-- REQUIRES EXPLICIT SINGLE-MIGRATION APPROVAL
--
-- Remediates Codex HIGH-1..HIGH-4 on the integrated C0-C8 base:
--   H1: serialize cast_council_vote vs close_agenda_item_vote via
--       FOR UPDATE on the agenda-item voting authority row
--   H2: issue_council_decision proves exact meeting/agenda/minutes/topic
--       /vote-result source relationships (zero mutation on forge)
--   H3: canonical decision FSM (issued → in_progress → completed,
--       controlled blocked path); centralized transition validation
--   H4: archive requires resolved decision follow-up; post-archive
--       denies decision/meeting/agenda/vote/minutes mutation
-- =====================================================================
