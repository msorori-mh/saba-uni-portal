...
export const Route = createFileRoute("/faculty-portal/change-password")({
...
function ChangePasswordPage() {
  ...
  const onSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const { error: rpcErr } = await supabase.rpc("complete_faculty_password_change");
      if (rpcErr) throw rpcErr;
      navigate({ to: "/faculty-portal", replace: true });
    } catch (err) {
