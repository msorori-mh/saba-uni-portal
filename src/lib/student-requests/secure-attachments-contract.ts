...
/**
 * @deprecated Compile-time availability removed. Resolve fail-closed via
 * `loadSecureAttachmentsRuntimeCapability` / `resolveSecureAttachmentsRuntimeAvailable`.
 * Kept as `false` so any leftover sync gate stays closed.
 */
