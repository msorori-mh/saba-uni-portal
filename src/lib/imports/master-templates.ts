...
export const MASTER_TEMPLATES: MasterTemplate[] = [
  ...
  // ===== الطلاب =====
  {
    ...
    title: "الطلاب",
    description: "بيانات الطلاب الأساسية + إنشاء حساب الدخول الداخلي تلقائياً عند create_login=true. لا تُدخل email/username/password/user_id/role.",
    category: "students",
    importerKey: "students",
    hasValidator: true,
    columns: [
      { name: "academic_number", description: "الرقم الأكاديمي (فريد) — هو اسم المستخدم وكلمة المرور الأولية", required: true, type: "text", example: "20251001" },
