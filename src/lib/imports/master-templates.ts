...
export const MASTER_TEMPLATES: MasterTemplate[] = [
  // ===== الهيكل الأكاديمي =====
  {
    ...
    hasValidator: true,
    columns: [
      { name: "department_code", description: "كود/اسم القسم الفريد (يطابق name_ar)", required: true, type: "text", example: "قسم علوم الحاسوب" },
      { name: "department_name_ar", description: "اسم القسم بالعربية", required: true, type: "text", example: "قسم علوم الحاسوب" },
      { name: "department_name_en", description: "اسم القسم بالإنجليزية", required: false, type: "text", example: "Computer Science" },
      { name: "description", description: "وصف القسم", required: false, type: "text", example: "قسم متخصص في علوم الحاسوب" },
      { name: "is_active", description: "نشط (true/false)", required: false, type: "boolean", example: true },
    ],
    examples: [
      ["قسم علوم الحاسوب", "قسم علوم الحاسوب", "Computer Science", "قسم متخصص في علوم الحاسوب", true],
      ["قسم تكنولوجيا المعلومات والاتصالات", "قسم تكنولوجيا المعلومات والاتصالات", "ICT", "قسم تقنية المعلومات", true],
      ["قسم نظم المعلومات", "قسم نظم المعلومات", "Information Systems", "قسم نظم المعلومات الإدارية", true],
    ],
  },
  {
    id: "programs",
    ...
    hasValidator: true,
    columns: [
      { name: "program_code", description: "كود البرنامج (فريد)", required: true, type: "text", example: "CS" },
      { name: "program_name_ar", description: "اسم البرنامج بالعربية", required: true, type: "text", example: "بكالوريوس علوم الحاسوب" },
      { name: "program_name_en", description: "اسم البرنامج بالإنجليزية", required: false, type: "text", example: "BSc Computer Science" },
      { name: "department_code", description: "اسم القسم بالعربية كما هو مسجل", required: true, type: "text", example: "قسم علوم الحاسوب" },
      { name: "degree_type", description: "نوع الدرجة", required: true, type: "enum", example: "bachelor", enumValues: ["bachelor", "master", "phd", "diploma"] },
      { name: "duration_years", description: "مدة البرنامج بالسنوات", required: true, type: "integer", example: 4 },
      { name: "is_active", description: "نشط (true/false)", required: false, type: "boolean", example: true },
    ],
    examples: [
      ["CS", "بكالوريوس علوم الحاسوب", "BSc Computer Science", "قسم علوم الحاسوب", "bachelor", 4, true],
      ["IT", "بكالوريوس تكنولوجيا المعلومات", "BSc Information Technology", "قسم تكنولوجيا المعلومات والاتصالات", "bachelor", 4, true],
      ["IS", "بكالوريوس نظم المعلومات", "BSc Information Systems", "قسم نظم المعلومات", "bachelor", 4, true],
    ],
  },
  {
    id: "levels",
    ...
    hasValidator: true,
    columns: [
      { name: "level_code", description: "كود المستوى (مميز داخل الملف)", required: true, type: "text", example: "L1" },
      { name: "level_name", description: "اسم المستوى", required: true, type: "text", example: "المستوى الأول" },
  ...
  },
  {
    ...
    description: "إنشاء/ربط حسابات الدخول لأعضاء هيئة التدريس عبر الإيميل الجامعي. login = university_email؛ كلمة المرور المؤقتة = academic_number (أو initial_password).",
    category: "faculty",
    importerKey: "faculty_accounts",
    hasValidator: true,
    columns: [
      { name: "employee_number", description: "الرقم الوظيفي (فريد، يجب وجوده مسبقاً) — للتعريف الإداري فقط", required: true, type: "text", example: "F2025001" },
      { name: "academic_number", description: "الرقم الأكاديمي — يُستخدم ككلمة مرور مؤقتة إذا تُرك initial_password فارغاً", required: false, type: "text", example: "FAC2025001" },
      { name: "email", description: "الإيميل الجامعي — اسم الدخول (login)", required: true, type: "text", example: "khalid@faculty.usr.edu.ye" },
      { name: "initial_password", description: "كلمة المرور المؤقتة (اختياري إذا وُجد academic_number)", required: false, type: "text", example: "FAC2025001" },
    ...
    examples: [
      ["F2025001", "FAC2025001", "khalid@faculty.usr.edu.ye", "", "د. خالد عبدالله", "قسم علوم الحاسوب", "Assistant Professor", "faculty_member", true],
      ["F2025002", "FAC2025002", "ahmed@faculty.usr.edu.ye", "", "د. أحمد سعيد", "قسم تكنولوجيا المعلومات والاتصالات", "Associate Professor", "faculty_member", true],
    ],
  },
  ...
  // ===== الطلاب =====
  {
    ...
    title: "الطلاب",
    description: "بيانات الطلاب الأساسية + إنشاء حساب الدخول عبر الإيميل الجامعي عند create_login=true.",
    category: "students",
    importerKey: "students",
    hasValidator: true,
    columns: [
      { name: "academic_number", description: "الرقم الأكاديمي (فريد) — للتعريف الأكاديمي فقط، ليس اسم دخول", required: true, type: "text", example: "20251001" },
      { name: "university_email", description: "الإيميل الجامعي — اسم الدخول (مطلوب عند create_login=true)", required: false, type: "text", example: "ahmed@students.usr.edu.ye" },
      ...
      { name: "create_login", description: "إنشاء حساب دخول داخلي تلقائياً (true/false)", required: false, type: "boolean", example: true },
      { name: "must_change_password", description: "إجبار تغيير كلمة المرور عند أول دخول (افتراضي true عند create_login=true)", required: false, type: "boolean", example: true },
      { name: "notes", description: "ملاحظات اختيارية تُسجَّل في سجل التدقيق", required: false, type: "text", example: "ملاحظة" },
    ],
    examples: [
      ["20251001", "أحمد محمد علي", "Ahmed Mohammed", "ahmed@students.usr.edu.ye", "قسم تكنولوجيا المعلومات والاتصالات", "IT", "1", "2025-2026", "first", "regular", "active", "777000111", "male", "12345678901", true, true, ""],
      ["20251002", "فاطمة الزهراء", "Fatima Alzahra", "fatima@students.usr.edu.ye", "قسم علوم الحاسوب", "CS", "1", "2025-2026", "first", "regular", "active", "777000112", "female", "12345678902", true, true, ""],
  ...
  },
  {
    ...
    columns: [
      ...
      { name: "semester", description: "first / second", required: false, type: "text", example: "first" },
