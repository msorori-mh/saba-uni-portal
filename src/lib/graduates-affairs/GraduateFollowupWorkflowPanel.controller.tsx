...
export function GraduateFollowupWorkflowPanelController() {
    ...
    <div className="space-y-6" dir="rtl">
      ...
      <section className="rounded-2xl border bg-card p-5">
        <div className="flex items-center justify-between gap-3">
          <div>
            <h3 className="text-lg font-bold text-primary">فهرس أنواع المتابعة</h3>
      ...
      {selectedTypeId && (
        <section className="rounded-2xl border bg-card p-5">
          <h3 className="text-lg font-bold text-primary">إصدارات سير العمل</h3>
