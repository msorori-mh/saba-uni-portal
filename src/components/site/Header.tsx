  ...
  return (
    <header className="sticky top-0 z-50 border-b border-border/60 bg-background/95 backdrop-blur-lg">
      ...
      <div className="bg-primary-deep text-white/90 text-[11px]">
        <div className="container mx-auto flex items-center justify-center px-4 py-0.5">
      ...
      <div className="container mx-auto flex items-center justify-between gap-3 px-4 py-2">
        ...
        <Link to="/" className="flex items-center gap-3 group min-w-0">
          <div className="grid h-12 w-12 lg:h-14 lg:w-14 shrink-0 place-items-center rounded-lg bg-white p-1 shadow-card ring-1 ring-gold/30">
          ...
          <div className="leading-tight hidden md:block min-w-0">
            <div className="font-display font-extrabold text-primary text-sm lg:text-base truncate">كلية تكنولوجيا المعلومات وعلوم الحاسوب</div>
            <div className="text-[11px] lg:text-xs text-muted-foreground truncate">البوابة الإلكترونية — جامعة إقليم سبأ</div>
          </div>
        </Link>


        {/* Desktop nav — single row from xl */}
        ...
        {/* Portal buttons — 2xl only to avoid crowding 1280–1535; still in hero + mobile drawer */}
        {!isAuthed && (
      ...
      {/* Secondary nav row for tablet/intermediate widths (lg–xl) */}
      <div className="hidden lg:block xl:hidden border-t border-border/40 bg-surface/50">
