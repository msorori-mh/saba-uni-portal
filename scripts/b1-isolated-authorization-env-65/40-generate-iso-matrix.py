...
PROD = json.load(open(os.path.join(ROOT, "tests/b1-five-services-rpc-authorization-preflight-01/MATRIX.json")))
...
with open(os.path.join(OUT, "ISO-MATRIX.json"), "w", newline="\n") as fh:
...
with open(os.path.join(OUT, "41-negative-cases.sql"), "w", newline="\n") as fh:
