...
| STUDENT-REQUEST-SECURE-ATTACHMENTS-SOURCE-01.sql | PASS | PASS | PASS | SKIP | BEGIN INSERT 0 1 psql:/tmp/repeat-5.sql:26: ERROR:  relation "student_request_attachment_uploads" already exists |
| REQUEST-B1-TRUSTED-REFERENCE-VALIDATORS-05A.sql | PASS | PASS | SKIP | SKIP |  |
| REQUEST-B1-EXCUSED-ABSENCE-VOCABULARY-05A.sql | PASS | PASS | SKIP | SKIP | BEGIN DO CREATE FUNCTION REVOKE psql:/tmp/repeat-7.sql:93: ERROR:  CANONICAL_ABSENCE_REASON_TRIGGER_MISMATCH CONTEXT:  PL/pgSQL function inline_code_block line 25 at RAISE |
