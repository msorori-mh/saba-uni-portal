...
describe("B1 confirm-payment predecessor guard 01", () => {
  ...
  it("registers as manifest sequence_order 20 before secure reads, secure drafts, and gate 23", () => {
    ...
    // Promotion-map order 19 and manifest sequence_order 20 precede reads, drafts, and gate 23.
