...
global key, C7 legacy `enrollment_certificate` no-op, C8–C10 `staff_profiles`
status/user_id, C11–C12 `faculty_profiles` status/department, C13
`position_assignments` principal.
