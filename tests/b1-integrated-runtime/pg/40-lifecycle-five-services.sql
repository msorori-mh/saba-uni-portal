...
-- The disposable PG17 apply chain intentionally omits the already-applied
-- production migration that installs this workflow-side-effect trigger.
-- Recreate the official trigger in the disposable test database so the legal
-- act_on_b1_student_request_step_atomic(..., 'clear') path records clearances.
