...
const chain = [
  ...
  { step: "C5", migration: "supabase/migrations/20260810180000_councils_c5_minutes_lifecycle_02.sql", verifier: "docs/migration-drafts/councils-c0-c9-verifiers/POST-VERIFIER-C5.sql", pass: "COUNCILS_C5_PRODUCTION_POST_VERIFIER_PASS", sha: "0d945a6a886ea2b8be15de6dbd0b4a2a5f15b8bdf16e7b68a2ef2bb4644212e8" },
